//done with courtney in class...edit of original copy

String text = "a unicorn has a horn and is a magical creature that is cool and is also part deer";
...
void draw(){
  ...
  fill(255);
  textAlign(CENTER);
  text(results, width/4, height/4, width/4, height/4);
